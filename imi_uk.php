...
<div class="service-page-area">
	...
	<div class="service-page-content">
		<div class="container">
<?php 
	$query = "SELECT * FROM  tbl_immigration WHERE status='UK' && side='LEFT' ORDER BY id DESC limit 4";
...
<?php } } ?>
<?php 
	$query = "SELECT * FROM  tbl_immigration WHERE status='UK' && side='RIGHT' ORDER BY id DESC limit 4";
	$about = $db->select($query);
	if ($about) {
		while ($result = $about->fetch_assoc()) { 
?>
